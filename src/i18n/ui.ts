...
export const ui = {
  es: {
    ...
    chat: {
      ...
      greeting: '¡Hola! Soy Sofía, del equipo de S&G. Cuéntame qué proceso quieres automatizar, medir o mejorar y te oriento con gusto. 😊',
      placeholder: 'Escribe tu consulta…',
      inputLabel: 'Escribe tu mensaje',
      waButton: 'Hablar por WhatsApp',
      privacy: 'Al chatear aceptas el tratamiento de tus datos según la Ley 1581. No compartimos tu información.',
      typing: 'Escribiendo…',
      typingAria: 'Sofía está escribiendo',
      openAria: 'Abrir chat con S&G',
      closeAria: 'Cerrar chat',
      sendAria: 'Enviar mensaje',
      inactivity: 'Veo que quedamos en pausa. ¿Seguimos por aquí o prefieres que Sandra, nuestro contacto comercial, retome por WhatsApp con el resumen de la charla? Escríbeme cuando gustes, o contáctala directo al +57 324 3025107. 😊',
      ...
      waEmail: 'Correo',
      waPhone: 'Tel',
      fallbackEmpty: 'No pude generar una respuesta. Escríbenos por WhatsApp y te ayudamos enseguida: ',
      fallbackError: 'Ahora mismo no puedo responder por aquí. Escríbenos por WhatsApp: ',
